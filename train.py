...
def train():
    ...
    if args.local_rank in [-1, 0] and args.n_epochs > 0:
        os.rename(checkpoint_handler._saved[-1][1][-1], os.path.join(tb_logger.writer.log_dir, WEIGHTS_NAME))  # TODO (huggingface): PR in ignite to have better access to saved file paths (cleaner)
        tb_logger.close()
